...
static int main2(int numArgs, const char *args[])
{
  ...
  */
  ...
  if (encodeMode)
  {
    NCompress::NLzma2::CEncoder *encoderSpec = new NCompress::NLzma2::CEncoder;
    ...
    //AC UInt64 processedSize = encoderSpec->GetInputProcessedSize();
    
    //AC if (fileSizeWasUsed && processedSize != fileSize)\
      throw "Incorrect size of processed data";
  }
  else
  {
    NCompress::NLzma2::CDecoder *decoderSpec = new NCompress::NLzma2::CDecoder;
    CMyComPtr<ICompressCoder> decoder = decoderSpec;
    
    //AC decoderSpec->FinishStream = true;
    ...
    //AC if (unpackSizeDefined && unpackSize != decoderSpec->GetOutputProcessedSize())\
